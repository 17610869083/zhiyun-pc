...
import {public_opinion_entry} from '../../../services/api';
...
class TopicEditOpinionDetail extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            <p className="publicopinion">舆情录入</p>
...
export default Form.create()(TopicEditOpinionDetail);