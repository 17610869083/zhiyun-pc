...
class MulOpinion extends React.Component {
  constructor() {
    ...
    this.state = {
      ...
      sid: '',
      describe: {
        reltime: ['发布时间','게시 시간','発行時間','نام زمان','ཁྱབ་བསྒྲགས་བྱེད་ཡུན།', 'release time'],
        source: ['来源','소스','ソース','منبع ','ཡོང་ཁུངས།', 'source'],
        author: ['作者','저자','著者','ساخت شخص','རྩོམ་པ་པོ།', 'Author'],
        keyword: ['关键词','키워드','キーワード','کلید کلمه','གནད་ཚིག་འགའ།', 'Key words'],
        factor: ['要素','요소','要素','عناصر','རྒྱུ་རྐྱེན་གཙོ་བོ།', 'Element']
      },
      language: ['中文', '한국어', '日本語', 'ئۇيغۇر يېزىقى', 'བོད་ཡིག། ', 'English'],
      languageType: 0,
      yes: ['是', '이', 'はい', 'پۈتۈن دولەتتىن', 'རེད་', 'yes'],
      no: ['否', '아니요', 'いいえ', 'ياق', 'ཧྥོའུ་', 'no'],
      warning: {
        tip: ['设为预警', '미리 경고하다', '警報に設定する', 'ئۈچۈن تەسىس قىلىنغان ئالدىن سىگنال بېرىش', 'འཛུགས་རྒྱུ་། ཉེན་ཟོན་སྔོན་བརྡ་གཏོང་བ་', 'Set as warning'],
        title: ['确定要将这条信息设置为预警吗？', '이 정보를 조기 경보로 설치 할 것 인가?', 'この情報を警報に設定しますか?', 'بۇ ئۇچۇرنى تەسىس قىلىش ئۈچۈن ئالدىن سىگنال بېرىش كېرەك ؟ ', 'ཆ་འཕྲིན་གཏན་འཁེལ་བྱ་དགོས་། དོན་ཚན་འདི་བཀོད་སྒྲིག་བྱས་པ་། ཉེན་ཟོན་སྔོན་བརྡའི་ཡོད་དམ་།', 'Are you sure you want to set this information as an alert?']
      },
      negative: {
        tip: ['设为负面', '부정적인 것으로 꾸미다', '反対面に設定', 'يامان تەرەپكە ئۈچۈن تەسىس قىلىنغان', 'བཀག་རྒྱ་འཛུགས་རྒྱུ་།', 'Set to negative'],
        title: ['确定要将这条信息设置为负面吗', '이 정보를 부정적으로 설정 해야하 는가?', 'この情報を反対面に設定するか?', 'بۇ ئۇچۇرنى تەسىس قىلىش ئۈچۈن سەلبىي بېكىتىش كېرەك ؟ ', 'ཆ་འཕྲིན་གཏན་འཁེལ་བྱ་དགོས་། དོན་ཚན་འདི་བཀོད་སྒྲིག་བྱས་ནས་ལྡོག་ཕྱོགས་དམ་།？', 'Are you sure you want to set this information negative?']
      },
      positive: {
        tip: ['设为正面', '정면으로 세우다', '良い方向に設定', 'تەسىس قىلىنغان ياخشى تەرەپكە', 'མདུན་ཕྱོགས་ལ་བསྐོ་བཞག་བྱས་', 'Set to front'],
        title: ['确定要将这条信息设置为正面吗', '이 정보를 정면으로 설치 할 것 인가?', 'この情報を良い方向に設定するか?', 'بۇ ماددا ئۇچۇر بېكىتىش كېرەك ئۇدۇل تەسىس قىلىش ئۈچۈن', 'ཆ་འཕྲིན་གཏན་འཁེལ་བྱ་དགོས་། དོན་ཚན་འདི་བཀོད་སྒྲིག་བྱས་པ་། དྲང་ཕྱོགས་ཀྱི་དམ་།', 'Are you sure you want to set this message to be positive?']
      },
      neutral: {
        tip: ['设为中性', '중성으로 세우다', '中性に設定する', 'نېيترال ئۈچۈن تەسىس قىلىنغان', 'མ་ནིང་འཛུགས་རྒྱུ་།', 'Set to neutral'],
        title: ['确定要将这条信息设置为中性吗', '이 정보를 중성으로 만들어야 하나요?', 'この情報を中性に設定するか?', 'بۇ ئۇچۇرنى نېيترال بەلگىلەش كېرەك ؟ ', 'ཆ་འཕྲིན་གཏན་འཁེལ་བྱ་དགོས་། དོན་ཚན་འདི་བཀོད་སྒྲིག་ནི་མ་ནིང་དམ་།', 'Are you sure you want to set this information to neutral?']
      },
      del: {
      ...
      handleTip: {
        ...
        warningsuccess: ['成功设置为预警', '성공', '成功', 'مۇۋەپپەقىيەت', 'གྲུབ་འབྲས་ཐོབ་པའི་ངང་སྔོན་བརྡའི་ཆེད་འཇོག་', 'Are you sure you want to set this information as an alert?'],
      }
    }
  }
  componentDidMount() {
