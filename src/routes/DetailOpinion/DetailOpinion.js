          ...
          <div className="Top">
            ...
            <div className="operation">
              <div className="itemBox">
                <Popconfirm title="确定要将这条信息设置为预警吗？" onConfirm={this.warningConfirm.bind(this, sid)}
                            onCancel={this.deleteCancel.bind(this)} okText="是" cancelText="否">
                  <div className="operation-item" title="设为预警">
                    <img src={warningImg} alt="warning"/>
                  </div>
                </Popconfirm>
                <Popconfirm title="确定要将这条信息设置为负面吗？" onConfirm={this.negativeConfirm.bind(this, sid)}
                            onCancel={this.deleteCancel.bind(this)} okText="是" cancelText="否">
                  <div className="operation-item" title="设为负面">
                    <img src={negativeImg} alt="negative"/>
                  </div>
                </Popconfirm>
                <Popconfirm title="确定要将这条信息设置为正面吗？" onConfirm={this.positiveConfirm.bind(this, sid)}
                            onCancel={this.deleteCancel.bind(this)} okText="是" cancelText="否">
                  <div className="operation-item item-font" title="设为正面">
                    正
                  </div>
                </Popconfirm>
                <Popconfirm title="确定要将这条信息设置为中性吗？" onConfirm={this.neutralConfirm.bind(this, sid)}
                            onCancel={this.deleteCancel.bind(this)} okText="是" cancelText="否">
                ...
                <Popconfirm title="确定要删除这条信息吗？" onConfirm={this.deleteConfirm.bind(this, sid)}
                            onCancel={this.deleteCancel.bind(this)} okText="是" cancelText="否">
