...
class TodayOpinionBox extends React.PureComponent {
  ...
  render() {
    ...
    const todayAll = data['今日舆情'] && data['今日舆情'].length !== 0
      ? data['今日舆情'][4]['总数']
      : "";
    const todayWarning = data['今日舆情'] && data['今日舆情'].length !== 0
      ? data['今日舆情'][3]['预警']
      : "";
    const todayNegative = data['今日舆情'] && data['今日舆情'].length !== 0
      ? data['今日舆情'][2]['负面']
      : "";
    const yesterdayNegative = data['昨日舆情'] && data['昨日舆情'].length !== 0
      ? data['昨日舆情'][2]['负面']
      : "";
    const ratio = yesterdayNegative === 0
      ? 0
      : Number.parseInt((todayNegative - yesterdayNegative) / yesterdayNegative * 100, 10);
    return (<div className="today-opinion-box">
            ...
            <div className="opinion-info">
              <div className="content">
                <div className="icon-wrapper">
                  <IconFont type="icon-yuqing" style={{
                      color: '#FFFFFF',
                      fontSize: '50px'
                    }}/>
                </div>
            ...
            <div className="opinion-info">
              <div className="content">
                <div className="icon-wrapper" style={{
                  ...
                  <IconFont type="icon-shandian" style={{
                      color: '#ffffff',
                      fontSize: '50px'
                    }}/>
                </div>
            ...
            <div className="opinion-info">
              <div className="content">
                <div className="icon-wrapper" style={{
                  ...
                  <IconFont type="icon-jinggao" style={{
                      color: '#ffffff',
                      fontSize: '50px'
                    }}/>
                </div>
            ...
            <div className="opinion-info">
              <div className="content">
                <div className="icon-wrapper" style={{
                  ...
                  <IconFont type="icon-sastaishiganzhi" style={{
                      color: '#ffffff',
                      fontSize: '50px'
                    }}/>
                </div>
