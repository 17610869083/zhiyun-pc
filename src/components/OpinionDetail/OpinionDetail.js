...
class OpinionDetail extends React.Component {
    ...
    handleSearchBtn() {
        ...
        this.props.searchKeywordSync({seltype: this.state.seltype,
                ...
                <div className="item-bottom"  style={this.state.isSummaryShow ? {display: 'flex'} : {display: 'none'}}>
                    ...
                    <div>
                        ...
                        <Popover
                                content={
                                    <div>
                                        <Button type="primary" size="small" onClick={this.editDocNeg.bind(this, item.sid, 'neg')}>负面</Button>
                                        <Button type="primary" size="small" style={{marginLeft: '30px'}} onClick={this.editDocNeg.bind(this, item.sid, 'mid')}>中性</Button>
                                        <Button type="primary" size="small" style={{marginLeft: '30px'}} onClick={this.editDocNeg.bind(this, item.sid, 'pos')}>正面</Button>
                                    </div>
                                }
                                title="设置这条信息的倾向"
                                trigger="click"
                ...
                <div className="top">
                    <div className="left">
                        <div className="choose-all">
                            <Checkbox onChange={this.chooseAllOnChange.bind(this)} checked={this.state.checkedAll} className="check"></Checkbox>
                        </div>
